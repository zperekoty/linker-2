  ...
  >
    <div class="flex justify-center items-center p-3 bg-white dark:bg-black transition-all ease-in-out duration-300 flex-col">
      ...
      <div class="mt-3 flex items-center justify-center">
        <a
          href={url}
          class="flex justify-center items-center rounded-lg p-3 transition-all ease-in-out duration-300 hover:bg-[#00A6FB] text-[#191308] dark:text-[#F7F7FF] mr-3 text-sm lg:text-base"
          target="_blank"
        >
          Project link
        </a>
